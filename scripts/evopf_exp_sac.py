...
def main():
    ...
    for _ in range(times):
        ...
        rpoagent = RPOSAC(env, "./test", name=name, logger=logger, batch_size=256, max_steps=10, warmup=0, lr_dual=2e-2, corr_lr=1e-4,  eps=0.0001, eps_start=0.0001, lr_actor=1e-4, lr_critic=3e-4,
