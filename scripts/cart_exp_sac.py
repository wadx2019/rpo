...
def main():
    ...
    for _ in range(times):
        ...
        twagent = RPOSAC(env, "./test", name=name, logger=logger, batch_size=256, max_steps=10, warmup=0, lr_dual=0.2, corr_lr=2e-2, eps=5e-3, eps_start=5e-3, lr_actor=1e-4, lr_critic=3e-4,
